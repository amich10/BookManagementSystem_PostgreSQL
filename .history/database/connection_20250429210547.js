...
//migration
sequelizeObj.sync({force:true}) //force:true => migrates any changes made like change made in column name but this is not done as this deletes all data when changes made
.then(() =>{
